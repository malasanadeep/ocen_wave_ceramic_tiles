...
<nav class="bg-gray-800 p-4">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-6 text-white">
                ...
                <a href="order-admin.php" class="hover:bg-gray-700 px-3 py-2 rounded">Ordered</a> 
                <?php
...
<h2 class="text-3xl font-extrabold mb-6 text-gray-900 text-center">User Details</h2>
  ...
  <table class="table " id="myTable">
    ...
    <thead>
      <tr>
        ...
        <th scope="col" style="color:white;">Delete users</th>
      </tr>
    </thead>
    <tbody>
    <?php  
    ...
    $conn = mysqli_connect("localhost","root","","project");
        ...
        // $sqll= "DELETE `users` FROM where $id=no ";
