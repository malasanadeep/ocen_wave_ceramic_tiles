...
<nav class="bg-gray-800 p-4">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-6 text-white">
                ...
                <a href="inquiry-admin.php" class="hover:bg-gray-700 px-3 py-2 rounded">Inquiry</a>
                 <a href="order-admin.php" class="hover:bg-gray-700 px-3 py-2 rounded">Orderd</a>
                 <?php
  ...
  ?>
        ...
        <div class="md:hidden bg-gray-800 text-white space-y-1 px-2 pt-2 pb-3 hidden" id="mobile-menu">
            ...
            <a href="order-admin.php" class="block px-3 py-2 rounded hover:bg-gray-700">Order</a>
            <!-- <a href="#booking" class="block px-3 py-2 rounded hover:bg-gray-700">Booking</a> -->
        </div>
    </nav>
    </body>
    </html>
<h2 class="text-3xl font-extrabold mb-6 text-gray-900 text-center">Request For Price</h2>
  ...
  <table class="table " id="myTable">
    ...
    <thead>
      <tr>
        ...
        <th scope="col" style="color:white;">Request</th>
      </tr>
    </thead>
    <tbody>
    <?php  
