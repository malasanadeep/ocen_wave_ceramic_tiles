...
<?php include("header_and_footers/header.php"); ?>
    <div class="container mx-auto p-4">
        <h1 class="text-3xl font-bold mb-6 text-black text-center">Stone Cladding Tiles</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <!-- Product Card -->
             <?php
                ...
                // session_start();
                $query = mysqli_query($conn,"SELECT * FROM `product` WHERE `category` = 'Stone Cladding tiles'");
